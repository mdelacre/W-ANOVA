...
```{r "", echo=FALSE, fig.width = 100,fig.height=100,out.width = '100%',fig.cap = "Type I error rate of the F-test, W-test and F*-test under 5 conditions. Top left: cell a in Table 1; top right: cells b and c; bottom left: cells d and g; bottom middle: cells e and i; bottom right: cells f and h. "}
